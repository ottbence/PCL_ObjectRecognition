...
main (int argc, char *argv[])
{
  ...
  pcl::FPFHEstimation<PointType, NormalType, pcl::FPFHSignature33> descr_est;
  ...
  // Save it back.
	pcl::io::savePCDFileASCII("model_desc_FPFH.pcd", *model_descriptors);
  // Save it back.
	pcl::io::savePCDFileASCII("scene_desc_FPFH.pcd", *scene_descriptors);
  //
